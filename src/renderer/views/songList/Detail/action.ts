...
const getListId = (id: string, source: S.OnlineSource) => `${source}__${id}`

export const addSongListDetail = async(id: string, source: S.OnlineSource, name?: string) => {
...
export const playSongListDetail = async(id: string, source: S.OnlineSource, list?: S.Music.MusicInfoOnline[], index: number = 0) => {
