...
dd.gap-top
  div
    .p
      ...
      strong.hover.underline(aria-label="https://lyswhut.github.io/s-music-doc/desktop/faq/open-api" @click="openUrl('https://lyswhut.github.io/s-music-doc/desktop/open-api')") {{ $t('setting__open_api_tip_link') }}
</template>
