...
let userEqPresetList: S.SoundEffect.EQPreset[] | null = null
...
export const saveUserEQPreset = async(preset: S.SoundEffect.EQPreset) => {
  if (userEqPresetList == null) {
    // eslint-disable-next-line require-atomic-updates
    userEqPresetList = reactive(await getUserSoundEffectEQPresetList())
  }
...
let userConvolutionPresetList: S.SoundEffect.ConvolutionPreset[] | null = null
...
export const saveUserConvolutionPreset = async(preset: S.SoundEffect.ConvolutionPreset) => {
  if (userConvolutionPresetList == null) {
    // eslint-disable-next-line require-atomic-updates
    userConvolutionPresetList = reactive(await getUserSoundEffectConvolutionPresetList())
  }
...
// let userPitchShifterPresetList: S.SoundEffect.PitchShifterPreset[] | null = null
...
// }
// export const saveUserPitchShifterPreset = async(preset: S.SoundEffect.PitchShifterPreset) => {
