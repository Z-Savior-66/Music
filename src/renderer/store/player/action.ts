...
export const getList = (listId: string | null): Array<S.Music.MusicInfo | S.Download.ListItem> => {
...
export const getPlayIndex = (listId: string | null, musicInfo: S.Download.ListItem | S.Music.MusicInfo | null, isTempPlay: boolean): {
  playIndex: number
...
const setPlayerMusicInfo = (musicInfo: S.Music.MusicInfo | S.Download.ListItem | null) => {
  if (musicInfo) {
 ...
 */
export const setPlayMusicInfo = (listId: string | null, musicInfo: S.Download.ListItem | S.Music.MusicInfo | null, isTempPlay: boolean = false) => {
 ...
 */
export const addPlayedList = (playMusicInfo: S.Player.PlayMusicInfo) => {
 ...
 * @param list 歌曲列表
 */
export const addTempPlayList = (list: S.Player.TempPlayListItem[]) => {
  const topList: Array<Omit<S.Player.TempPlayListItem, 'top'>> = []
