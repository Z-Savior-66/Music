...
export const hasDislike = (info: S.Music.MusicInfo | S.Download.ListItem) => {
...
export const initDislikeInfo = ({ musicNames, rules, names, singerNames }: S.Dislike.DislikeInfo) => {
...
export const addDislikeInfo = (infos: S.Dislike.DislikeMusicInfo[]) => {
...
// export const updateDislikeInfo = (info: S.Dislike.ListItem) => {
