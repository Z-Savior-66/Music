...
export const toNewMusicInfo = (oldMusicInfo: any): S.Music.MusicInfo => {
  ...
  const newInfo = {
    ...
    meta: meta as S.Music.MusicInfoOnline['meta'],
  }
...
export const toOldMusicInfo = (minfo: S.Music.MusicInfo) => {
 ...
 * @param musicInfo
 */
export const fixNewMusicInfoQuality = (musicInfo: S.Music.MusicInfo) => {
...
export const filterMusicList = <T extends S.Music.MusicInfo>(list: T[]): T[] => {
