...
declare namespace S {
  namespace Sync {
    ...
    type ServerSyncListActions = WarpPromiseRecord<{
      onListSyncAction: (action: S.Sync.List.ActionList) => void
    }>
    ...
    type ServerSyncDislikeActions = WarpPromiseRecord<{
      onDislikeSyncAction: (action: S.Sync.Dislike.ActionList) => void
    }>
    ...
    type ClientSyncListActions = WarpPromiseRecord<{
      ...
      list_sync_get_sync_mode: () => S.Sync.List.SyncMode
      list_sync_get_list_data: () => S.Sync.List.ListData
      list_sync_set_list_data: (data: S.Sync.List.ListData) => void
    ...
    type ClientSyncDislikeActions = WarpPromiseRecord<{
      ...
      dislike_sync_get_sync_mode: () => S.Sync.Dislike.SyncMode
      dislike_sync_get_list_data: () => S.Dislike.DislikeRules
      dislike_sync_set_list_data: (data: S.Dislike.DislikeRules) => void
