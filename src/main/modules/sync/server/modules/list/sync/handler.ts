...
// const broadcast = async(socket: S.Socket, key: string, data: any, excludeIds: string[] = []) => {
//   if (!wss) return
...
// export const sendListAction = async(action: S.Sync.List.ActionList) => {
//   console.log('sendListAction', action.action)
//   // io.sockets
//   await broadcast('list:sync:action', action)
// }

// export const registerListHandler = (_wss: S.SocketServer, socket: S.Socket) => {
//   if (!wss) {
//     wss = _wss
...
const handler: S.Sync.ServerSyncHandlerListActions<S.Sync.Server.Socket> = {
