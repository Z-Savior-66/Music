...
export const queryAllUserList = () => {
  const list = createListQueryStatement().all() as S.DBService.UserListInfo[]
 ...
 */
export const insertUserLists = (lists: S.DBService.UserListInfo[], isClear: boolean = false) => {
  const db = getDB()
  const listClearStatement = createListClearStatement()
  const listInsertStatement = createListInsertStatement()
  db.transaction((lists: S.DBService.UserListInfo[]) => {
 ...
 * @param lists 列表
 */
export const updateUserLists = (lists: S.DBService.UserListInfo[]) => {
  const db = getDB()
 ...
 * @param list
 */
export const insertMusicInfoList = (list: S.DBService.MusicInfo[]) => {
  ...
  const db = getDB()
  db.transaction((musics: S.DBService.MusicInfo[]) => {
 ...
 */
export const insertMusicInfoListAndRefreshOrder = (list: S.DBService.MusicInfo[], listId: string, listAll: S.DBService.MusicInfo[]) => {
  const musicInfoInsertStatement = createMusicInfoInsertStatement()
  const musicInfoOrderInsertStatement = createMusicInfoOrderInsertStatement()
  const musicInfoOrderDeleteByListIdStatement = createMusicInfoOrderDeleteByListIdStatement()

  const db = getDB()
  db.transaction((list: S.DBService.MusicInfo[], listId: string, listAll: S.DBService.MusicInfo[]) => {
 ...
 * @param list
 */
export const updateMusicInfos = (list: S.DBService.MusicInfo[]) => {
...
export const queryMusicInfoByListId = (listId: string) => {
  ...
  return musicInfoQueryStatement.all({ listId }) as S.DBService.MusicInfo[]
}
 ...
 */
export const moveMusicInfo = (fromId: string, ids: string[], musicInfos: S.DBService.MusicInfo[]) => {
  const musicInfoInsertStatement = createMusicInfoInsertStatement()
  const musicInfoOrderInsertStatement = createMusicInfoOrderInsertStatement()
  ...
  const db = getDB()
  db.transaction((fromId: string, ids: string[], musicInfos: S.DBService.MusicInfo[]) => {
 ...
 */
export const moveMusicInfoAndRefreshOrder = (fromId: string, ids: string[], toId: string, musicInfos: S.DBService.MusicInfo[], toListAll: S.DBService.MusicInfo[]) => {
  const musicInfoInsertStatement = createMusicInfoInsertStatement()
  const musicInfoDeleteStatement = createMusicInfoDeleteStatement()
  const musicInfoOrderDeleteStatement = createMusicInfoOrderDeleteStatement()
  const musicInfoOrderInsertStatement = createMusicInfoOrderInsertStatement()
  ...
  const db = getDB()
  db.transaction((fromId: string, ids: string[], musicInfos: S.DBService.MusicInfo[], toListAll: S.DBService.MusicInfo[]) => {
    for (const id of ids) {
      musicInfoDeleteStatement.run({ listId: fromId, id })
      musicInfoOrderDeleteStatement.run({ listId: fromId, id })
    }
...
export const queryMusicInfoByListIdAndMusicInfoId = (listId: string, musicInfoId: string) => {
  ...
  return musicInfoByListAndMusicInfoIdQueryStatement.get({ listId, musicInfoId }) as S.DBService.MusicInfo | null
}
...
export const queryMusicInfoByMusicInfoId = (id: string) => {
  ...
  return musicInfoByMusicInfoIdQueryStatement.all(id) as S.DBService.MusicInfo[]
}
 ...
 */
export const updateMusicInfoOrder = (listId: string, musicInfoOrders: S.DBService.MusicInfoOrder[]) => {
  const db = getDB()
  const musicInfoOrderInsertStatement = createMusicInfoOrderInsertStatement()
  const musicInfoOrderDeleteByListIdStatement = createMusicInfoOrderDeleteByListIdStatement()
  db.transaction((listId: string, musicInfoOrders: S.DBService.MusicInfoOrder[]) => {
    musicInfoOrderDeleteByListIdStatement.run(listId)
 ...
 */
export const overwriteMusicInfo = (listId: string, musicInfos: S.DBService.MusicInfo[]) => {
  const db = getDB()
  const musicInfoDeleteByListIdStatement = createMusicInfoDeleteByListIdStatement()
  const musicInfoOrderDeleteByListIdStatement = createMusicInfoOrderDeleteByListIdStatement()
  const musicInfoInsertStatement = createMusicInfoInsertStatement()
  const musicInfoOrderInsertStatement = createMusicInfoOrderInsertStatement()
  db.transaction((listId: string, musicInfos: S.DBService.MusicInfo[]) => {
 ...
 * @param musicInfos 歌曲列表
 */
export const overwriteListData = (lists: S.DBService.UserListInfo[], musicInfos: S.DBService.MusicInfo[]) => {
  const db = getDB()
  const listClearStatement = createListClearStatement()
  const listInsertStatement = createListInsertStatement()
  ...
  const musicInfoOrderInsertStatement = createMusicInfoOrderInsertStatement()
  db.transaction((lists: S.DBService.UserListInfo[], musicInfos: S.DBService.MusicInfo[]) => {
