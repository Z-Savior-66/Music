...
export const queryLyric = (id: string) => {
  ...
  return lyricQueryStatement.all(id) as S.DBService.Lyricnfo[]
}
...
export const queryRawLyric = (id: string) => {
  ...
  return rawLyricQueryStatement.all(id) as S.DBService.Lyricnfo[]
}
 ...
 * @param lyrics 列表
 */
export const insertRawLyric = (lyrics: S.DBService.Lyricnfo[]) => {
  const db = getDB()
  const rawLyricInsertStatement = createRawLyricInsertStatement()
  db.transaction((lyrics: S.DBService.Lyricnfo[]) => {
 ...
 * @param lyrics 列表
 */
export const updateRawLyric = (lyrics: S.DBService.Lyricnfo[]) => {
  const db = getDB()
 ...
 * @param lyrics 列表
 */
export const insertEditedLyric = (lyrics: S.DBService.Lyricnfo[]) => {
  const db = getDB()
 ...
 * @param lyrics 列表
 */
export const updateEditedLyric = (lyrics: S.DBService.Lyricnfo[]) => {
  const db = getDB()
